    ...
    return (
      <main className="min-h-screen bg-black text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <a href="/login" className="px-6 py-3 bg-violet-600 hover:bg-violet-500 text-white font-semibold rounded-xl">Go to Login</a>
        </div>
      </main>
    );
  }
    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-10 flex flex-col gap-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-zinc-400">Transform your ideas into stunning videos using Google Veo 3</p>
        </div>
